...
class InvestmentQuiz extends StatefulWidget {
  const InvestmentQuiz({super.key});

  @override
  State<InvestmentQuiz> createState() => _InvestmentQuizState();
}

class _InvestmentQuizState extends State<InvestmentQuiz> {
  @override
